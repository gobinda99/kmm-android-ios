...
import com.gobinda.kotlin.multiplatfom.mobile.sample.android.utils.*
import com.gobinda.kotlin.multiplatfom.mobile.sample.android.utils.TripleState
import com.gobinda.kotlin.multiplatfom.mobile.sample.android.ui.*
...
@Composable
fun SignInScreen(
    vm: SignInViewModel = koinViewModel(), onNavigateSignUp: () -> Unit, onNavigateHome: () -> Unit
) {
